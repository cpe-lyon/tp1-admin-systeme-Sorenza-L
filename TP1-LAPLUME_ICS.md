...
Le programme ***ls*** se situe dans les alias.
...
La commande ***ls*** liste les dossier en y appliquant une coloration syntaxique.
...
J'utilise la commande **man -k conversion | wc -l**.

### 20. A l’aide de la commande find, recherchez tous les fichiers se nommant passwd présents sur la machine

<pre>
laplume@serveur:~$ sudo find / -name passwd
[sudo] password for laplume:
/etc/passwd
/etc/pam.d/passwd
/etc/cron.daily/passwd
/snap/core/7713/etc/cron.daily/passwd
/snap/core/7713/etc/pam.d/passwd
/snap/core/7713/etc/passwd
/snap/core/7713/usr/bin/passwd
/snap/core/7713/usr/share/bash-completion/completions/passwd
/snap/core/7713/usr/share/doc/passwd
/snap/core/7713/var/lib/extrausers/passwd
...
J'utilise la commande : **sudo find /-name passwd > ~/list_passwd_files.txt >/dev/null**
...
<pre>
laplume@serveur:~$ locate history.log
/var/log/apt/history.log
/var/log/apt/history.log.1.gz
</pre>
Le fichier history.log se trouve dans ***/var/log/apt/history.log et  /var/log/apt/history.log.1.gz***
...
J'utilise la commande **cp .bashrc .bashrc_bak**.
